...
int main(int argc, char const *argv[])
{
  ...
  //./calibrate_stereo -w 5 -h 6 -n 9 -L /calibrationImages/ -R /calibrationImages/ -l left -r right -o cam_stereo.yml
  static struct poptOption options[] = {
    ...
    { "leftimg_prefix",'l',POPT_ARG_STRING,&leftimg_prefix,0,"Left image prefix","STR" },
    { "rightimg_prefix",'r',POPT_ARG_STRING,&rightimg_prefix,0,"Right image prefix","STR" },
  ...
  load_image_points(board_width, board_height, num_imgs, square_size,
                    leftimg_dir, rightimg_dir, leftimg_prefix, rightimg_prefix);
